...
{
    public partial class PasswordPrompt : WorktipsWalletForm
    {
        ...
        {
            DialogResult dialogResult = MessageBox.Show("Are you sure you want to cancel?", "Worktips Wallet Cancel?", MessageBoxButtons.YesNo);
